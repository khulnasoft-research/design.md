...
export declare const ParserErrorCode: z.ZodEnum<
  ['EMPTY_CONTENT', 'NO_YAML_FOUND', 'YAML_PARSE_ERROR', 'DUPLICATE_SECTION', 'UNKNOWN_ERROR']
>;
...
export declare const SCHEMA_KEYS: readonly [
  'version',
  'name',
  'description',
  'colors',
