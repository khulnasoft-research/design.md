...
export declare const ModelErrorCode: z.ZodEnum<["INVALID_COLOR", "INVALID_DIMENSION", "INVALID_TYPOGRAPHY_PROP", "UNRESOLVED_REFERENCE", "CIRCULAR_REFERENCE", "REFERENCE_TO_NON_PRIMITIVE", "NESTING_DEPTH_EXCEEDED", "UNKNOWN_ERROR"]>;
